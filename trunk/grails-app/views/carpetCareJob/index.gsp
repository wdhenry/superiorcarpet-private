		...
		<div id="list-carpetCareJob" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="customerId" title="${message(code: 'carpetCareJob.customerId.label', default: 'Customer Id')}" />
				...
				<tbody>
				<g:each in="${carpetCareJobInstanceList}" status="i" var="carpetCareJobInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${carpetCareJobInstance.id}">${fieldValue(bean: carpetCareJobInstance, field: "customerId")}</g:link></td>
