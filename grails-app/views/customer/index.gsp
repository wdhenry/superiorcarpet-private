		...
		<div id="list-customer" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="addressLineOne" title="${message(code: 'customer.addressLineOne.label', default: 'Address Line One')}" />
					
						<g:sortableColumn property="addressLineTwo" title="${message(code: 'customer.addressLineTwo.label', default: 'Address Line Two')}" />
