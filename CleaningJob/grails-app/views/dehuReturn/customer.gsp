...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'dehumidifiers.label', default: 'Dehumidifies')}" />
		<g:set var="entityName1" value="${message(code: 'customer.label', default: 'Customer')}" />
	...
	<body>
		...
		<div id="show-customer" class="content scaffold-show" role="main">
			<h1><g:message code="default.show.label" args="[entityName1]" /></h1>
