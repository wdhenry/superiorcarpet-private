...
class gsp_cleaningJob_dailyWorkSearchsearch_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dailyWorkSearch/search.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',26,['bean':(dailySearchCommandInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(dailySearchCommandInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',36,['url':([resource:dailySearchCommandInstance, action:'search'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1432088623023L
