...
class gsp_cleaningJob_extractionJobSearchdetails_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/extractionJobSearch/details.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(13)
invokeTag('render','g',27,['template':("formExtractionJob")],-1)
printHtmlPart(14)
createTagBody(2, {->
invokeTag('message','g',33,['code':("default.button.print.label"),'default':("Print")],-1)
})
invokeTag('link','g',33,['class':("print"),'action':("print"),'controller':("extractionJobSearch"),'resource':(extractionJobCommandInstance)],2)
printHtmlPart(15)
})
...
public static final long LAST_MODIFIED = 1432088626199L
