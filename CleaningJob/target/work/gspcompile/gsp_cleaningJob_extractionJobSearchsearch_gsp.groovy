...
class gsp_cleaningJob_extractionJobSearchsearch_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/extractionJobSearch/search.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',26,['bean':(extractionSearchCommandInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(extractionSearchCommandInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',36,['url':([resource:extractionSearchcommandInstance, action:'search'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1432088625629L
