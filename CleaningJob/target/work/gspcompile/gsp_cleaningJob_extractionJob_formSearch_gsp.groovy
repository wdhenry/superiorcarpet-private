...
class gsp_cleaningJob_extractionJob_formSearch_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/extractionJob/_formSearch.gsp" }
public Object run() {
Writer out = getOut()
