...
class gsp_cleaningJob_extractionJobsummary_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/extractionJob/summary.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1434075645116L
