...
class gsp_cleaningJob_layoutsmain_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('layoutTitle','g',10,['default':("Superior Carpet Main Menu")],-1)
})
...
createTagBody(1, {->
printHtmlPart(7)
invokeTag('render','g',21,['template':("/common/topbar")],-1)
printHtmlPart(8)
invokeTag('layoutBody','g',26,[:],-1)
printHtmlPart(9)
invokeTag('render','g',28,['template':("/common/footer")],-1)
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1432088623213L
