...
class gsp_cleaningJob_customeredit_gsp extends GroovyPage {
...
invokeTag('eachError','g',27,['bean':(customerInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(customerInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
...
invokeTag('form','g',38,['url':([resource:customerInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1432088625397L
