...
class gsp_cleaningJob_fanReturnedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/fanReturn/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',26,['bean':(fansInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(fansInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('hiddenField','g',30,['name':("version"),'value':(fansInstance?.version)],-1)
printHtmlPart(20)
...
invokeTag('form','g',37,['url':([resource:fansInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1432088623206L
