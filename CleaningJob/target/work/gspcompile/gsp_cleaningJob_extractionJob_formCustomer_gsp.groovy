...
class gsp_cleaningJob_extractionJob_formCustomer_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/extractionJob/_formCustomer.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(4)
invokeTag('message','g',16,['code':("customer.lastName.label"),'default':("Company/Last Name")],-1)
printHtmlPart(5)
...
printHtmlPart(6)
invokeTag('message','g',25,['code':("customer.addressLineOne.label"),'default':("Address")],-1)
printHtmlPart(5)
...
printHtmlPart(7)
invokeTag('message','g',34,['code':("customer.addressLineTwo.label"),'default':("Address")],-1)
printHtmlPart(2)
...
public static final long LAST_MODIFIED = 1432088624965L
