...
class gsp_cleaningJob_cleaningJob_formSearch_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/cleaningJob/_formSearch.gsp" }
public Object run() {
Writer out = getOut()
