...
class gsp_cleaningJob_dehumidifiersListcustomer_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dehumidifiersList/customer.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'dehumidifiers.label', default: 'Dehumidifies'))],-1)
printHtmlPart(1)
...
public static final long LAST_MODIFIED = 1432088626291L
